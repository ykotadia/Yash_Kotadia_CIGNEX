...
void writeDataMem(int num1, int num2, int num3)
{
	rewind(fptr);
	char ID[20];
	char IDStr[40] = "ID=";
...
int main(int argc, char *argv[])
{
	...
	printf("END of process! num1=%d, num2=%d, num3=%d", num1, num2, num3);
